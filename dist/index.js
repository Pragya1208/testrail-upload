...
import { validateRowsAndOverrides, formatMandatoryHelp, formatHeaderCheckReport, } from "./validation.js";
    ...
    tools: [
        {
            ...
            inputSchema: {
                ...
                properties: {
                    ...
                    default_type: {
                        type: "string",
                        description: "Default Type when Risk (CSV) is absent; default is Functional. Values: Accessibility | Compatibility | Destructive | Functional | Other | Performance | Security | Usability",
                    },
                    default_status: {
                        type: "string",
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        if (name === "convert_csv_to_testrail_format") {
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: "1) Header check (provided CSV → TestRail mapping):\n" +
                            headerCheck +
        ...
        if (!validation.valid) {
            return {
                content: [
                    {
                        type: "text",
                        text: "Step 1 – Header check and validation failed.\n\n" +
                            headerCheckReport +
                            "\n\n" +
                            validation.message,
                    },
        ...
        const defaultFramework = typeof argsObj.default_framework === "string"
            ? argsObj.default_framework
            : undefined;
        const defaultType = typeof argsObj.default_type === "string" ? argsObj.default_type : "Functional";
